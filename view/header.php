    ...
    <nav class="navbar navbar-expand-lg navbar-light ">
        <div class="container-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a class="nav-link text-dark btn btn-outline-light me-3" href="?page=absentList">
                    Absent List
                </a>
                <a class="nav-link text-dark btn btn-outline-light me-3" href="?page=presentList">
                    Event Participants
                </a>

                <a class="nav-link text-dark btn btn-outline-light" href="./login.php">
                    Login
                </a>
            </div>
        </div>
