...
$obj = new my_class();
extract($_REQUEST);
$total_absent = $obj->Total_Count_By_Cond("election_attendance_profile", "attendance_flag=0 AND active_flag=1");
?>

<div class="absentInfo container mt-5">


    <h3 class="text-center text-light p-4">Absent Participants Information</h3>

    <div class="d-flex p-3 justify-content-between">
        <h4 class="text-center text-light"> Total Absent: <?php echo $total_absent; ?></h4>
        <a class="btn btn-outline-light " target="_blank" href="./pages/print_absent.php"> Print</a>
    </div>
    ...
    <table class="table w-75 m-auto">
        ...
        <tbody>
            <?php foreach ($obj->View_All_By_Cond("election_attendance_profile", "active_flag=1 AND attendance_flag=0") as $value) {
